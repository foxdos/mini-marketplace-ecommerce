                                    ...
                                    <div class="category-menu categori-hide categori-not-visible">
                                        <nav>
                                            <ul>
                                                <li class="cr-dropdown"><a href="#">Clothing <span class="icon-arrow-right"></span></a>
                                                    <div class="category-menu-dropdown ct-menu-res-height-1">
                                                        <div class="single-category-menu ct-menu-mrg-bottom category-menu-border">
                                                            <h4>Men Clothing</h4>
                                                            <ul>
                                                                <li><a href="shop.php">Sleeveless shirt</a></li>
                                                                <li><a href="shop.php">Cotton T-shirt</a></li>
                                                                <li><a href="shop.php">Trench coat</a></li>
                                                                <li><a href="shop.php">Cargo pants</a></li>
                                                            </ul>
                                                        </div>
                                                        <div class="single-category-menu ct-menu-mrg-bottom ct-menu-mrg-left">
                                                            <h4>Women Clothing</h4>
                                                            <ul>
                                                                <li><a href="shop.php">Wedding dress</a></li>
                                                                <li><a href="shop.php">Gym clothes</a></li>
                                                                <li><a href="shop.php">Cotton T-shirt </a></li>
                                                                <li><a href="shop.php">Long coat</a></li>
                                                            </ul>
                                                        </div>
                                                        <div class="single-category-menu">
                                                            <h4>Kids Clothing</h4>
                                                            <ul>
                                                                <li><a href="shop.php">Winter Wear </a></li>
                                                                <li><a href="shop.php">Occasion Gowns</a></li>
                                                                <li><a href="shop.php">Birthday Tailcoat</a></li>
                                                                <li><a href="shop.php">Stylish Unicorn</a></li>
                                                            </ul>
                                                        </div>
                                                        <div class="single-category-menu">
                                                            <a href="product-details.php"><img src="assets/images/menu/menu-categori-1.png" alt=""></a>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="cr-dropdown"><a href="shop.php">Baby Boy </a></li>
                                                <li class="cr-dropdown"><a href="shop.php">Accessories </a></li>
                                                <li class="cr-dropdown"><a href="shop.php">Shoes</a></li>
                                                <li class="cr-dropdown"><a href="shop.php">Shirt</a></li>
                                                <li class="cr-dropdown"><a href="shop.php">T-Shirt</a></li>
                                                <li class="cr-dropdown"><a href="shop.php">Coat</a></li>
                                                <li class="cr-dropdown"><a href="shop.php">Jeans</a></li>
                                                <li class="cr-dropdown"><a href="shop.php">Collection </a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
